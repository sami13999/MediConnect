      ...
      >
        <SafeAreaView style={styles.safeHeader} edges={['top']}>
          <View style={styles.headerTopRow}>
            <Text style={styles.premiumHeader}>Consultations</Text>
          </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.empty}>No consultations available yet.</Text>
          </View>
        }
        renderItem={({ item }) => (
          <TouchableOpacity
          ...
          >
            ...
            >
              {item.profile_picture ? (
                <Image source={{ uri: item.profile_picture }} style={styles.avatarImg} />
              ) : (
                <View style={styles.avatarPlaceholder}>
                  <Text style={styles.avatarText}>{item.first_name ? item.first_name[0] : "D"}</Text>
                </View>
              )}
            </TouchableOpacity>
            ...
            <View style={styles.chatInfo}>
              <View style={styles.chatHeaderRow}>
                <Text style={styles.chatName} numberOfLines={1}>Dr. {item.first_name}</Text>
                <Text style={styles.chatTime}>10:59 AM</Text>
              </View>
              <View style={styles.chatSubRow}>
                <Text style={styles.chatSnippet} numberOfLines={1}>
                  Tap to resume secure chat with your specialist...
                </Text>
              </View>
            </View>
          </TouchableOpacity>
        ...
        <View style={styles.previewBackdrop}>
          <SafeAreaView style={styles.previewHeader}>
            ...
            <View style={styles.previewHeaderInfo}>
              ...
              <Text style={styles.previewSubTitle}>Dr. {selectedProfile ? selectedProfile.first_name : ""}</Text>
            </View>
          </SafeAreaView>
          <View style={styles.previewContent}>
             {selectedProfile?.profile_picture ? (
                <Image source={{ uri: selectedProfile.profile_picture }} style={styles.fullImage} resizeMode="contain" />
              ) : (
                <View style={styles.largePlaceholder}>
                   <Text style={styles.largePlaceholderText}>
                     {selectedProfile ? selectedProfile.first_name[0] : "D"}
                   </Text>
                </View>
              )}
          </View>
